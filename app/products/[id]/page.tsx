...
export default function ProductDetailPage() {
  ...
  // Add a helper to check if the product is a deal (e.g., by checking a list of deal ids in localStorage or context, or by a prop if available)
  const isProductADeal = false // Replace with actual implementation
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                {/* Hide the bargain button and BargainingChatbot if the product is a deal */}
                {!isProductADeal && (
                  <Button 
                    variant="outline" 
                    size="lg"
